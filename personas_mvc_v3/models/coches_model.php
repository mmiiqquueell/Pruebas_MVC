...
class coches_model {
    ...
    private $db, $coches, $id, $marca, $modelo, $fabricado;
    ...
    public function getFabricado() {return $this->fabricado;}
    public function setFabricado($fabricado) {$this->fabricado = $fabricado;}
    ...
    */
    public function get_coches(){
        ...
        while($filas=$consulta->fetch_assoc()){$this->coches[]=$filas;}
        return $this->coches;
    }
    ...
    */
    public function insertar() {
         $sql = "INSERT INTO coches (marca, modelo, fabricado) VALUES ('{$this->marca}','{$this->modelo}','{$this->fabricado}')";
